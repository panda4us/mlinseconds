...
class SolutionModel(nn.Module):
    def __init__(self, input_size, output_size, solution):
        ...
        #self.hidden_size4 = solution.hidden_size4
        ...
        #self.linear5 = nn.Linear(self.hidden_size4, output_size)
        ...
        self.activation4=solution.activations[solution.activation_hidden_key_4]
...
if run_grid_search:
    gs.GridSearch().run(Config(), case_number=4, random_order=False, verbose=False)
else:
